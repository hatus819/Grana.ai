...
# Also signs JWTs (SIMPLE_JWT SIGNING_KEY), so a guessable key means token forgery.
...
if os.environ.get('USE_SQLITE', 'True') == 'True':
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': os.environ.get('DB_NAME', 'grana_ai_db'),
...
# CORS — browser clients (web dashboard, Expo web) live on other origins
