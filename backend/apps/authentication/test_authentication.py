...
class RegisterPasswordValidationTests(APITestCase):
    def test_register_rejects_weak_password(self):
        """
        Django's AUTH_PASSWORD_VALIDATORS must run on API registration:
        an all-numeric password is rejected with a field error.
        """
...
class AuthenticationTests(APITestCase):
    def setUp(self):
        ...
        self.user_data = {
            ...
            'password': 'Tr0car-Forte#2026',
            'password_confirm': 'Tr0car-Forte#2026',
            'phone': '123456789',
            'cpf': '123.456.789-00'
        }
